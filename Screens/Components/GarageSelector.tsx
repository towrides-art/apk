...
const GarageSelector = ({
 ...
 const service_providers = [
  ...
  const [searchText, setSearchText] = useState(" Enter Drop Location");
          ...
          // padding:10,
           ...
           <View style={{
            ...
            alignItems:'center'
                    ...
                    />
                    <StyledText weight="medium" style={{fontSize:20, color: theme.colors.text.primary }}>Drop Location</StyledText>
                    </View>
       <View style={{
            display:"flex",
            flexDirection:'row',
